...
public class RestAPI {
    private final String urlString = "http://rha.somee.com/handler1.ashx";
    ...
    public JSONObject CreateNewPatientAccount(String PatientName,String EmailID,int DoctorID,String Hospital,String TimeDate,String UserName) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "CreateNewPatientAccount");
        p.put("PatientName",mapObject(PatientName));
        p.put("EmailID",mapObject(EmailID));
        p.put("DoctorID",mapObject(DoctorID));
        p.put("Hospital",mapObject(Hospital));
        p.put("TimeDate",mapObject(TimeDate));
        p.put("UserName",mapObject(UserName));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
    ...
    public JSONObject GetUserDetails(String firstName) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
    ...
    public JSONObject GetPatientDetails(String FilterUserName) throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "GetPatientDetails");
        p.put("FilterUserName",mapObject(FilterUserName));
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
    ...
    public JSONObject GetDoctorDetails() throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "GetDoctorDetails");
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
